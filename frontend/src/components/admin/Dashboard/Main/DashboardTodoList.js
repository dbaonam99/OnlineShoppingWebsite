...
export default function DashboardTodoList(props) {
    ...
    useEffect(()=>{
        axios.get(`http://pe.heromc.net/todos`)
            .then(res => {
    ...
    const clickToCheck = (event)=>{
        ...
        axios.post('http://pe.heromc.net/todos/update', {
            id: id,
            isDone: isDone
        }) 
    }
    ...
    const addNewTodo = (event)=>{
        ...
        axios.post('http://pe.heromc.net/todos', data)
        .then((res) => {   
            axios.get(`http://pe.heromc.net/todos`)
                .then(res2 => {
    ...
    const deleteTodo = (event) => { 
        ...
        axios.post('http://pe.heromc.net/todos', {
            delete: true,
            id: id
        }).then((res)=>{
            const virtualTodo = []
